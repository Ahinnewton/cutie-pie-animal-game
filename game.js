...
const modes={easy:{start:10,max:18,ramp:220,hearts:4,spawn:1.15},normal:{start:12,max:21,ramp:160,hearts:3,spawn:1},hard:{start:15,max:26,ramp:115,hearts:2,spawn:.82}};
const levels=[
