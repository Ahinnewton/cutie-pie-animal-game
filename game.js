...
const modes={easy:{start:9,max:16,ramp:225,hearts:8,spawn:1.15},normal:{start:10.5,max:19,ramp:168,hearts:6,spawn:1},hard:{start:13,max:23,ramp:122,hearts:4,spawn:.82}};
const levels=[
